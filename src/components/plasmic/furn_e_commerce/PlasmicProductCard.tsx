...
import * as sty from "./PlasmicProductCard.module.css"; // plasmic-import: 3sXhAKublOas/css

import ShoppingCartIcon from "./icons/PlasmicIcon__ShoppingCart"; // plasmic-import: OiErU7MkvU6D/icon
import HeartOIcon from "./icons/PlasmicIcon__HeartO"; // plasmic-import: dte-Y-nxlrRs/icon
import ExpandIcon from "./icons/PlasmicIcon__Expand"; // plasmic-import: xZ62eZAHw6Hi/icon
...
function PlasmicProductCard__RenderFunc(props: {
  ...
  return (
    ...
    >
      <div className={classNames(defaultcss.all, sty.freeBox__zadHh)}>
        {p.renderPlasmicSlot({
          defaultContents: (
            <img
              alt={""}
              className={classNames(defaultcss.img, sty.img__jpU6Y)}
              role={"img"}
              src={f1CmXMdwB5I8Fr}
            />
          ),
        ...
        {(hasVariant(variants, "onSale", "onSale") ? true : false) ? (
          <div
            className={classNames(defaultcss.all, sty.freeBox__dCt2E, {
              [sty.freeBox__onSale__dCt2E3SfuS]: hasVariant(
                variants,
                "onSale",
                "onSale"
              )
        ...
        {(triggers.hover_root ? true : false) ? (
          <p.Stack
            as={"div"}
            hasGap={true}
            className={classNames(defaultcss.all, sty.freeBox___3Sm6Y)}
          >
            <ShoppingCartIcon
              className={classNames(defaultcss.all, sty.svg__qKGv)}
              role={"img"}
            />
            ...
            <HeartOIcon
              className={classNames(defaultcss.all, sty.svg__rt4M)}
              role={"img"}
            />

            <ExpandIcon
              className={classNames(defaultcss.all, sty.svg___24FBq)}
              role={"img"}
            />
          </p.Stack>
        ) : null}
      ...
      {(hasVariant(variants, "withReviews", "withReviews") ? true : false)
        ? p.renderPlasmicSlot({
            defaultContents: (
              <Ratings
                className={classNames("__wab_instance", sty.ratings___6JjI5)}
              />
            ),
      ...
      <p.Stack
        as={"div"}
        hasGap={true}
        className={classNames(defaultcss.all, sty.freeBox__dGdOs)}
      >
        {p.renderPlasmicSlot({
