...
import * as sty from "./PlasmicMenuButton.module.css"; // plasmic-import: TlhKCtfqm6NW/css

import BarsIcon from "./icons/PlasmicIcon__Bars"; // plasmic-import: tFiL9dpweMSk/icon
import TimesIcon from "./icons/PlasmicIcon__Times"; // plasmic-import: 1H95dzPDz0uU/icon
    ...
    >
      ...
      >
        {(hasVariant(variants, "expanded", "expanded") ? false : true) ? (
          <BarsIcon
            className={classNames(defaultcss.all, sty.svg__neiNj, {
              [sty.svg__expanded__neiNjEmHk]: hasVariant(
                variants,
                "expanded",
                "expanded"
              )
        ...
        {(hasVariant(variants, "expanded", "expanded") ? true : false) ? (
          <TimesIcon
            className={classNames(defaultcss.all, sty.svg__sqJs, {
              [sty.svg__expanded__sqJsEmHk]: hasVariant(
                variants,
                "expanded",
                "expanded"
              )
