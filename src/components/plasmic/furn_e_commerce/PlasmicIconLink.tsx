...
import * as sty from "./PlasmicIconLink.module.css"; // plasmic-import: WZRh3ALaka92/css
    ...
    >
      ...
      >
        {p.renderPlasmicSlot({
          defaultContents: (
            <svg
              className={classNames(defaultcss.all, sty.svg___9TMdK)}
              role={"img"}
            />
          ),
