...
import * as sty from "./PlasmicFeatureItem.module.css"; // plasmic-import: Xm6ls7vw1pX/css
...
function PlasmicFeatureItem__RenderFunc(props: {
  ...
  return (
    ...
    >
      <div className={classNames(defaultcss.all, sty.freeBox__a0BoH)}>
        <div className={classNames(defaultcss.all, sty.freeBox__syLeK)} />

        <div className={classNames(defaultcss.all, sty.freeBox__ph1Ez)}>
          <p.Stack
            as={"div"}
            hasGap={true}
            className={classNames(defaultcss.all, sty.freeBox___5WHz)}
          >
            <div
            ...
            <div className={classNames(defaultcss.all, sty.freeBox__sv4Hk)}>
              <div
                className={classNames(
                  defaultcss.all,
                  defaultcss.__wab_text,
            ...
            <p.Stack
              as={"div"}
              hasGap={true}
              className={classNames(defaultcss.all, sty.freeBox__snM6Z)}
            >
              <LinkButton
